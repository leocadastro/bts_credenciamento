...
<title>TradeCenter Web BackOffice - Brazil Trade Shows</title>
...
<table align="center" width="600" border="0" cellspacing="0" cellpadding="0"  class="conteudo_site fs12px">
  ...
  <tr>
    <td colspan="2" class="bold">Vari&aacute;veis de Sess&atilde;o - <% =Session.Contents.Count %> Encontradas</td>
  </tr>
<%
Dim item, itemloop
