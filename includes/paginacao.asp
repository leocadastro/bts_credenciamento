...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
      <tr>
      	<% If intpage > 1 Then %>
        	<td width="25" height="25" align="center" style="cursor:pointer;" onclick="document.location='<%=strURL%>&acp=a&pag=<%=intpage%>';"><img src="/images/ico_pg_voltar.gif" alt="Pág. Anterior" width="24" height="24" /></td>
        <% Else %>
        ...
        <% If Cint(intpage) < Cint(fim) Then %>
        	<td width="25" height="25" align="center" style="cursor:pointer;" onclick="document.location='<%=strURL%>&acp=p&pag=<%=intpage%>';"><img src="/images/ico_pg_prox.gif" alt="Próxima Pág." width="24" height="24" /></td>
		<% Else %>
        	<td width="25" height="25" >&nbsp;</td>
        <% End If %> 
      </tr>
