...
Antes de finalizar sua compra conheça as políticas e condições de venda de Ingresso para o evento ABF Franchising Expo São Paulo:
<br><br>
<strong>1 - DO OBJETO</strong><br>
1.1. A compra estará sujeita à disponibilidade de ingressos e à aprovação da operadora de seu cartão de crédito.
<br><br>
1.2. Não será permitida a entrada de menores de 16 anos desacompanhados.
<br><br>
...
4.1. Para sua segurança, todas as compras de ingresso, via internet, somente poderão ser entregues ao proprietário do número do CPF utilizado na compra (o nome do titular do pedido deve ser o mesmo do CPF apresentado na retirada do ingresso), mediante a apresentação dos seguintes documentos: comprovante de pagamento da compra e CPF ou Carteira de Motorista de cada pessoa, no qual foi adquirido o ingresso.
<br><br>
4.2. O cliente deverá retirar os ingressos adquiridos nos postos de atendimento exclusivos para compra de ingresso online, na entrada dos pavilhões Azul e Branco do Expo Center Norte , localizado na Rua José Bernardo Pinto , 333 – São Paulo/SP – Brasil, sem taxa de cobrança de entrega.
<br><br>
4.3. Para retirada dos ingressos, será requisitada a apresentação de um documento (Carteira de Motorista ou CPF) contendo nome do titular e número do CPF.
<br><br>
4.4. Para a retirada de ingressos por terceiros, este deverá apresentar instrumento de procuração do titular do pedido com firma reconhecida em cartório e poderes específicos para a retirada dos ingressos que ficará retida, devendo ainda o outorgado/representante comparecer portando com documentos originais de identificação.
<br><br>
4.5. Ocorrendo a impossibilidade de entrega dos ingressos, por ausência de pessoa habilitada para o recebimento, não ocorrerá qualquer devolução de valores, sendo que o comprador está ciente das Condições Gerais deste.
<br><br>
<strong>5 - DAS CONDIÇÕES GERAIS DE USO</strong><br>
5.1. Terceira idade: Pessoas com mais de 60 anos podem adquirir seus ingressos com desconto de 50% de acordo com o Estatuto do Idoso (Lei nº10.741/2003, cap V, art 23).
<br><br>
5.2. O ingresso no valor de R$ 60,00 é válido para os 04 dias de feira.
<br><br>
5.3. Visando à proteção dos direitos dos clientes e de terceiros, caso ocorra a tentativa ou a efetiva utilização indevida dos serviços de conveniência de compra on-line de ingressos, a proprietária do evento poderá indicar os dados do cliente às autoridades públicas, aos serviços de proteção ao crédito, dentre outros, para início dos procedimentos legais e administrativos cabíveis.
<br>
...
<br><br>
5.4. Caso qualquer cláusula do presente contrato seja considerada nula ou sem efeito, não resultará na nulidade total do contrato, permanecendo em vigor nas demais cláusulas, permanecendo os direitos e obrigações ora acordados.
<br><br>
5.5. Fica eleito o foro da Comarca de São Paulo, Estado de São Paulo, para dirimir quaisquer dúvidas oriundas do presente contrato, excluindo-se qualquer outro foro, por mais privilegiado que seja.
                    </div>
