...
<!-- // Alexandre Fischer - 03/06/2014 - Desativar compra de ingressos da ABF pelo e-commerce -->
<!--script type="text/javascript">
	alert("A compra de ingressos da ABF 2014 está disponível apenas no local da feira, durante a realização do evento.");
	window.location.href = "http://credenciamento.btsinforma.com.br";
</script-->
<%
...
if request("teste_paypal") = "JhA8NRwSQi" then session("teste_paypal") = true
'// 
If Request("DC") <> "" Then
	session("dc") = Request("DC")
	'response.write session("dc")
	'response.end
	...
	'response.end
	Id_Visitante = ConsultarWS(session("dc"))
	'response.write ID_Visitante
	'response.end
End If

'==================================================
' Nova Implementacao - 15/05/2014 - Leandro Santiago | HD 8471
' INICIO - Correção de Erro de Sessao Expirada
'==================================================
'Session("cliente_edicao") 		= 46
'Session("cliente_idioma") 		= 1
'Session("cliente_tipo") 		= 1
'==================================================
' FIM - Correção de Erro de Sessao Expirada
'==================================================
...
If Session("cliente_edicao") = "" OR Session("cliente_idioma") = "" OR Session("cliente_tipo") = "" Then
		...
		'TODO: verificar novo link com Fabian
End If
...
<table width="870" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <!--
    '==================================================
    ' Nova Implementacao - 27/05/2014 - Leandro Santiago | HD 8575
    ' INICIO - Implementar mensagem de para comprar de ingresso
    '==================================================
    -->
    <table width="100%" border="0" cellspacing="3" cellpadding="3">
      ...
      <tr>
        <td><span class="fs_12px arial cor_cinza2">Para efetuar a compra do seu ingresso é necessário ter feito seu credenciamento antecipadamente.<br> Faça seu credenciamento no site: <a href="http://www.mbxeventos.net/aol3abf2016"> www.mbxeventos.net/aol3abf2016</a></span></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
	 ...
	 <!--
    '==================================================
    ' FIM - Implementar mensagem de para comprar de ingresso
    '==================================================
    -->
    <!-- Form -->
	<form action="default.asp" method="post" id="prcAcessoTicket" name="prcAcessoTicket">
            <!-- Alert error -->
