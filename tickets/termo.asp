...
Antes de finalizar sua compra conheça os Termos e Condições de venda de Ingresso para o evento ABF Franchising Expo 2016:
<br><br>
...
Rua José Bernardo Pinto, 333 - Vila Guilherme, sem a cobrança de taxa de conveniência.<br><br>
4.3. Para a retirada de ingressos por terceiros, este deverá apresentar instrumento de procuração do titular do pedido com firma reconhecida em cartório e poderes específicos para a retirada dos ingressos, a qual ficará retida, devendo, ainda, o outorgado/representante comparecer portando seus documentos originais de identificação.<br><br>
4.4. Ocorrendo à impossibilidade de retirada do ingresso, por ausência de pessoa habilitada para o recebimento, não ocorrerá qualquer devolução de valores, sendo que o comprador está ciente dos Termos e Condições.<br><br>
...
<br><br>5.3. Cada ingresso é válido para os 04 dias do evento, podendo ser adquiridos antecipadamente por meio do site do evento ao custo de R$ 60,00 até dia 14 de junho de 2016. Caso deixe para comprar durante a realização do evento, de 15 a 18 de junho de 2016, na bilheteria local ou pelo site custará R$ 70,00.
...
<br><br>5.5. O ato de credenciamento e compra de ingressos para a feira ABF Franchising Expo não dá direito à participação nos Cursos Simultâneos da Franchising Week, visto que este evento é voltado exclusivamente ao público franqueador.
