...
Cliente_Edicao 	= Session("cliente_edicao")

If Cliente_Edicao = "" Then
	Cliente_Edicao = Limpar_Texto(Request("Cliente_Edicao"))
End If
...
If Len(ID_Visitante) <> 0 Or Len(CodPedido) <> 0 Then
	...
	If Not RS_Recuperar_Senha.BOF or Not RS_Recuperar_Senha.EOF Then
		...
		Enviar_Email_Senha Cliente_Edicao, Session("cliente_idioma"), "", "", Email, Nome, Senha, "Enviar_Ticket", CodPedido, ID_Visitante
