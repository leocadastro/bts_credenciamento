...
'	response.write("<hr>" & SQL_Listar & "<hr>")
	...
	Else
		Atividade_ptb 	= RS_Listar("Atividade_ptb")
		Atividade_eng	= RS_Listar("Atividade_eng")
		Atividade_esp	= RS_Listar("Atividade_esp")
		id_ramo			= RS_Listar("id_ramo")
  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Atividade ID: <%=id%></span></td>
      ...
      <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <input type="hidden" id="acao" name="acao" value="upd_atividade">
            <input type="hidden" id="id" name="id" value="<%=id%>">
              ...
              <tr>
				...
				If not RS_Ramos.BOF or not RS_Ramos.EOF Then
					...
					selecionado = ""
					If Cstr(RS_Ramos("ID_Ramo")) = Cstr(id_ramo) Then selecionado = " selected "
					%><option value="<%=RS_Ramos("ID_Ramo")%>" <%=selecionado%>><%=RS_Ramos("Ramo_PTB")%></option><%
						RS_Ramos.MoveNext
					Wend
					RS_Ramos.Close
				End If
              ...
              <tr>
                ...
                <td class="titulo_noticias_home"><input name="Atividade_ptb" id="Atividade_ptb" type="text" class="admin_txtfield_login" size="30" value="<%=Atividade_ptb%>" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Atividade - ENG</td>
                <td class="titulo_noticias_home"><input name="Atividade_eng" id="Atividade_eng" type="text" class="admin_txtfield_login" size="30" value="<%=Atividade_eng%>" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Atividade - ESP</td>
                <td class="titulo_noticias_home"><input name="Atividade_esp" id="Atividade_esp" type="text" class="admin_txtfield_login" size="30" value="<%=Atividade_esp%>" /></td>
              </tr>
              <tr>
