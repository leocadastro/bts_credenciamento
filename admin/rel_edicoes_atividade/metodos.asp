...
Select Case Acao
	...
	Case "menus_relacionar"
		atividades	= Split( Trim(Request("id_atividade")) )
		id_edicao	= Request("id_edicao")
		
		'1 - Remover todos Atualmente Relacionados
		SQL_Del_1 =	"Delete From Relacionamento_Edicoes_Atividade " &_
					"Where " &_
					"	id_edicao = " & id_edicao
		...
		For i = 0 to Ubound(atividades)
			SQL_Inserir =	"Insert Into Relacionamento_Edicoes_Atividade " &_
							"(id_edicao, id_atividade, id_admin) " &_
							"Values " &_
							"(" & id_edicao & "," & Replace(atividades(i),",","") & "," & Session("admin_id_usuario") & ")"
