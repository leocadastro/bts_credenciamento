...
Conexao.Open Application("cnn")
	...
	SQL_Atividade =	"Select " &_
					...
					"	,Ramo_PTB " &_
					"	,Ae.Ativo " &_
					"From AtividadeEconomica as AE " &_
					"Inner Join RamodeAtividade as RA " &_
					"	ON RA.id_ramo = AE.id_ramo " &_
					"Order by Ramo_PTB, Atividade_PTB "
	Set RS_Atividade = Server.CreateObject("ADODB.Recordset")
	RS_Atividade.Open SQL_Atividade, Conexao
  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Relacionar Edi&ccedil;&otilde;es &gt; Atividade Econ&ocirc;mica<br>
                      ...
                      <table width="500" border="0" cellpadding="0" cellspacing="5">
                        <tr>
                          ...
                          <table width="390" border="0" cellspacing="0" cellpadding="0" class="fs11px t_arial bold c_vermelho">
                            <tr>
                              <td colspan="2" align="center">Atividade Econômica</td>
                            </tr>
                          </table>
                            <div style="height:380px; overflow:auto;" id="lista_contato">
                              <table id="lista_menus" width="470" border="0" cellspacing="0" cellpadding="0" class="admin_tela_login">
                                <%
								If not RS_Atividade.BOF or RS_Atividade.EOF Then
									i = 0
									While not RS_Atividade.EOF
										checado = ""
										For w = Lbound(IDs) to Ubound(IDs)
											If Cstr(IDs(w)) = Cstr(RS_Atividade("ID_Atividade")) Then 
												checado = " checked "
												Exit For
											End If
										Next
										ativo = RS_Atividade("ativo")
										txt_desativado = ""
										...
										<td width="30" height="24" align="center"><input type="checkbox" name="id_atividade" id="id_atividade" value="<%=RS_Atividade("ID_Atividade")%>" <%=checado%>></td>
                                        <td onClick="check(<%=i%>);" class="cursor"><span class="color: #669"><%=RS_Atividade("Ramo_PTB")%></span> - <%=RS_Atividade("Atividade_PTB")%> <%=txt_desativado%></td>
                                        </tr>
                                    	<%
										RS_Atividade.MoveNext
										i = i + 1
									Wend
									RS_Atividade.Close
								End If
