  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Relacionar Ramos - Edi&ccedil;&otilde;es<br>
								...
								If not RS_Ramos.BOF or RS_Ramos.EOF Then
									...
									While not RS_Ramos.EOF
										...
										For w = Lbound(IDs) to Ubound(IDs)
											If Cstr(IDs(w)) = Cstr(RS_Ramos("id_ramo")) Then 
												checado = " checked "
												Exit For
											End If
										Next
										...
										<td width="30" height="24" align="center"><input type="checkbox" name="id_ramo" id="id_ramo" value="<%=RS_Ramos("id_ramo")%>" <%=checado%>></td>
                                        <td onClick="check(<%=i%>);" class="cursor"><%=RS_Ramos("Ramo_PTB")%> <%=txt_desativado%></td>
                                        </tr>
                                    	<%
										RS_Ramos.MoveNext
										i = i + 1
