...
Select Case Acao
	...
	Case "menus_relacionar"
		cargo 		= Split( Trim(Request("id_SubCargo")) )
		id_edicao	= Request("id_edicao")
		
		'1 - Remover todos Atualmente Relacionados
		SQL_Del_1 =	"Delete From Relacionamento_Edicoes_SubCargo " &_
					"Where " &_
					"	id_edicao = " & id_edicao
		...
		For i = 0 to Ubound(cargo)
			SQL_Inserir =	"Insert Into Relacionamento_Edicoes_SubCargo " &_
							"(id_edicao, id_subcargo, id_admin) " &_
							"Values " &_
							"(" & id_edicao & "," & Replace(cargo(i),",","") & "," & Session("admin_id_usuario") & ")"
