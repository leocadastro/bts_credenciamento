...
'	response.write("<hr>" & SQL_Listar & "<hr>")
	...
	Else
		funcionarios_ptb 	= RS_Listar("Funcionarios_Qtde_PTB")
		funcionarios_eng	= RS_Listar("Funcionarios_Qtde_ENG")
		funcionarios_esp	= RS_Listar("Funcionarios_Qtde_ESP")
  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Quantidade de funcion&aacute;rios ID: <%=id%></span></td>
      ...
      <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <input type="hidden" id="acao" name="acao" value="upd_funcionarios">
            <input type="hidden" id="id" name="id" value="<%=id%>">
              ...
              <tr>
                ...
                <td class="titulo_noticias_home"><input name="funcionarios_Qtde_PTB" id="funcionarios_Qtde_PTB" type="text" class="admin_txtfield_login" size="30" value="<%=funcionarios_ptb%>" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Quantidade - ENG</td>
                <td class="titulo_noticias_home"><input name="funcionarios_Qtde_ENG" id="funcionarios_Qtde_ENG" type="text" class="admin_txtfield_login" size="30" value="<%=funcionarios_eng%>" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Quantidade - ESP</td>
                <td class="titulo_noticias_home"><input name="funcionarios_Qtde_ESP" id="funcionarios_Qtde_ESP" type="text" class="admin_txtfield_login" size="30" value="<%=funcionarios_esp%>" /></td>
              </tr>
              <tr>
