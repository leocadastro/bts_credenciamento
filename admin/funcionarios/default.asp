...
Conexao.Open Application("cnn")
	...
	SQL_Listar = 	"Select " &_
					...
					"	,Funcionarios_Qtde_ENG " &_
					"	,Funcionarios_Qtde_ESP " &_
					"	,Ativo " &_
					"	,Data_Cadastro " &_
					"From Funcionarios_Qtde " &_
					"Order by ID_Funcionarios_Qtde ASC"
  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Quantidade de funcion&aacute;rios</span></td>
      ...
      <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <input type="hidden" id="acao" name="acao" value="add_funcionarios">
              <tr>
              ...
              <tr>
                <td height="30" class="titulo_menu_site_bts">Quantidade - PTB</td>
                <td class="titulo_noticias_home"><input name="funcionarios_Qtde_PTB" id="funcionarios_Qtde_PTB" type="text" class="admin_txtfield_login" size="30" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Quantidade - ENG</td>
                <td class="titulo_noticias_home"><input name="funcionarios_Qtde_ENG" id="funcionarios_Qtde_ENG" type="text" class="admin_txtfield_login" size="30" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Quantidade - ESP</td>
                <td class="titulo_noticias_home"><input name="funcionarios_Qtde_ESP" id="funcionarios_Qtde_ESP" type="text" class="admin_txtfield_login" size="30" /></td>
              </tr>
              <tr>
		...
		%>
            ...
            %>
              <tr bgcolor="#FFFFFF" 
                ...
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Funcionarios_Qtde")%>';" align="left"><%=RS_Listar("ID_Funcionarios_Qtde")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Funcionarios_Qtde")%>';" align="left"><%=Rs_listar("Funcionarios_Qtde_PTB")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Funcionarios_Qtde")%>';" align="left"><%=Rs_listar("Funcionarios_Qtde_ENG")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Funcionarios_Qtde")%>';" align="left"><%=Rs_listar("Funcionarios_Qtde_ESP")%></td>
                <td class="borda_dir linha_16px cursor" align="center">
                <%
					ativo = Rs_listar("Ativo")
					If ativo = true OR ativo = 1 Then
						%><img src="/img/geral/icones/ok.gif" width="20" height="20" alt="ativo" title="ativo" onClick="document.location = 'metodos.asp?id=<%=Rs_listar("ID_Funcionarios_Qtde")%>&acao=desativar';"><%
					Else
						%><img src="/img/geral/icones/nok.gif" width="20" height="20" alt="desativado" title="desativado" onClick="document.location = 'metodos.asp?id=<%=Rs_listar("ID_Funcionarios_Qtde")%>&acao=ativar';"><%
                	End If
				%>
                </td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Funcionarios_Qtde")%>';" align="left"><%=FormatDateTIme(Rs_listar("Data_Cadastro"),2)%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Funcionarios_Qtde")%>';" align="center"><img src="/admin/images/ico_pg_prox.gif" width="15" height="15" alt="Ver Expositor" title="Ver Expositor" border="0"></td>
              </tr>
              <%
                RS_Listar.MoveNext()
            Wend
