...
produto	= Limpar_Texto(Request("produto"))

if empresa <> "" then
	url_busca = url_busca & "&empresa=" & empresa
	busca = "Where E.Razao_Social like '%" & empresa & "%'"
end if

if produto <> "" then
	url_busca = url_busca & "&produto=" & produto
	
	If empresa <> "" then
		busca = busca & " and Rp.Principal_Produto like '%" & produto & "%'"
	Else
		busca = "Where Rp.Principal_Produto like '%" & produto & "%'"
	End If
end if
...
Conexao.Open Application("cnn")
	...
	SQL_Listar = 	"Select " &_
					...
					busca &_
					"Order by Rp.Principal_Produto ASC, E.Razao_Social ASC"
  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Produtos</span></td>
	...
	<!--BUSCA-->
      <table width="900" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td>
          	<form action="/admin/produtos/default.asp" method="post" name="busca">
                <span class="titulo_noticias_home" style="width: 500px; float: left;">
                    ...
                    Produto: <input type="text" name="produto" id="produto" class="admin_txtfield_login">
		...
		%>
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="fs11px t_arial">
              <tr>
                ...
                <td width="300" class="borda_dir linha_16px" align="center"><b>Produto</b></td>
			...
			RS_Cadastro.Close
              ...
              <tr bgcolor="#FFFFFF" 
                ...
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID")%>';" align="left"><%=RS_Listar("ID")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID")%>';" align="left"><%=RS_Listar("Empresa")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID")%>';" align="left"><%=RS_Listar("Principal_Produto")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID")%>';" align="left"><%=FormatDateTIme(RS_Listar("Data_Cadastro"),2)%></td>
                <td class="borda_dir linha_16px cursor" align="center">
                    ...
                    <a href="editar.asp?id=<%=RS_Listar("ID")%>">
