...
If campo_busca <> "" Then
	...
	SQL_Busca = "Where Cargo_PTB like '%" & campo_busca & "%' or Cargo_ENG like '%" & campo_busca & "%' or Cargo_ESP like '%" & campo_busca & "%' "
End If
  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Cargos</span></td>
        <td width="270" align="center" valign="middle" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;">
	        <a href="/admin/rel_edicoes_cargo/"><img src="/admin/images/bt_link.png" height="48" border="0" style="float: left; margin-top: -5px;"/>
            <div id="relacionamento_link">Relacionar Cargos</div></a>
        </td>
      ...
      <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <input type="hidden" id="acao" name="acao" value="add_cargo">
              <tr>
              ...
              <tr>
                ...
                <td class="titulo_noticias_home"><input name="cargo_ptb" id="cargo_ptb" type="text" class="admin_txtfield_login" size="30" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Cargo - ENG</td>
                <td class="titulo_noticias_home"><input name="cargo_eng" id="cargo_eng" type="text" class="admin_txtfield_login" size="30" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Cargo - ESP</td>
                <td class="titulo_noticias_home"><input name="cargo_esp" id="cargo_esp" type="text" class="admin_txtfield_login" size="30" /></td>
              </tr>
              <tr>
            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                <form id="buscar" name="buscar" method="post" action="default.asp">
                  ...
                  <tr>
                    ...
                    <td class="titulo_noticias_home"><input name="campo_busca" id="campo_busca" type="text" class="admin_txtfield_login" size="30" /></td>
                  </tr>
                  <tr>
                    <td width="260" height="30" class="titulo_menu_site_tec">&nbsp;</td>
		...
		%>
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="fs11px t_arial">
              <tr>
                ...
                <td width="65" align="center" class="borda_dir linha_16px"><b>Sub-Cargo</b></td>
            ...
            %>
              <tr bgcolor="#FFFFFF" 
                ...
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Cargo")%>';" align="left"><%=RS_Listar("ID_Cargo")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Cargo")%>';" align="left"><%=Rs_listar("Cargo_PTB")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Cargo")%>';" align="left"><%=Rs_listar("Cargo_ENG")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Cargo")%>';" align="left"><%=Rs_listar("Cargo_ESP")%></td>
                <td class="borda_dir linha_16px " align="center">
                <%
					subcargo = Rs_listar("subcargo")
					If subcargo = true OR subcargo = 1 Then
                ...
                <%
					...
					If ativo = true OR ativo = 1 Then
						%><img src="/img/geral/icones/ok.gif" width="20" height="20" alt="ativo" title="ativo" onClick="document.location = 'metodos.asp?id=<%=Rs_listar("ID_Cargo")%>&acao=desativar';"><%
					Else
						%><img src="/img/geral/icones/nok.gif" width="20" height="20" alt="desativado" title="desativado" onClick="document.location = 'metodos.asp?id=<%=Rs_listar("ID_Cargo")%>&acao=ativar';"><%
                	End If
				%>
                </td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Cargo")%>';" align="left"><%=FormatDateTIme(Rs_listar("Data_Cadastro"),2)%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Cargo")%>';" align="center"><img src="/admin/images/ico_pg_prox.gif" width="15" height="15" alt="Ver Expositor" title="Ver Expositor" border="0"></td>
              </tr>
              <%
                RS_Listar.MoveNext()
            Wend
