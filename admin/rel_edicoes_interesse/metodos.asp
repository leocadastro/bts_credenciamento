...
Select Case Acao
	...
	Case "menus_relacionar"
		area		= Split( Trim(Request("ID_AreaInteresse")) )
		id_edicao	= Request("id_edicao")
		
		'1 - Remover todos Atualmente Relacionados
		SQL_Del_1 =	"Delete From Relacionamento_Edicoes_AreaInteresse " &_
					"Where " &_
					"	id_edicao = " & id_edicao
		...
		For i = 0 to Ubound(area)
			SQL_Inserir =	"Insert Into Relacionamento_Edicoes_AreaInteresse " &_
							"(id_edicao, ID_AreaInteresse, id_admin) " &_
							"Values " &_
