...
'	response.write("<hr>" & SQL_Listar & "<hr>")
	...
	Else
		InteresseFeira_ptb 	= RS_Listar("Feira_PTB")
		InteresseFeira_eng	= RS_Listar("Feira_ENG")
		InteresseFeira_esp	= RS_Listar("Feira_ESP")
  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Interesse ID: <%=id%></span></td>
        ...
        <tr>
          ...
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <input type="hidden" id="id" name="id" value="<%=id%>">
              ...
              <tr>
                <td height="30" class="titulo_menu_site_bts">Interesse - PTB</td>
                <td class="titulo_noticias_home"><input name="InteresseFeira_ptb" id="InteresseFeira_ptb" type="text" class="admin_txtfield_login" size="30" value="<%=InteresseFeira_ptb%>" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Interesse - ENG</td>
                <td class="titulo_noticias_home"><input name="InteresseFeira_eng" id="InteresseFeira_eng" type="text" class="admin_txtfield_login" size="30" value="<%=InteresseFeira_eng%>" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Interesse - ESP</td>
                <td class="titulo_noticias_home"><input name="InteresseFeira_esp" id="InteresseFeira_esp" type="text" class="admin_txtfield_login" size="30" value="<%=InteresseFeira_esp%>" /></td>
              </tr>
              <tr>
