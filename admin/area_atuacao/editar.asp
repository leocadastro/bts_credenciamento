...
'	response.write("<hr>" & SQL_Listar & "<hr>")
	...
	Else
		AreaAtuacao_ptb 	= RS_Listar("AreaAtuacao_ptb")
		AreaAtuacao_eng	= RS_Listar("AreaAtuacao_eng")
		AreaAtuacao_esp	= RS_Listar("AreaAtuacao_esp")
  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Área de Atua&ccedil;&atilde;o ID: <%=id%></span></td>
      ...
      <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <input type="hidden" id="acao" name="acao" value="upd_atuacao">
            <input type="hidden" id="id" name="id" value="<%=id%>">
              ...
              <tr>
                <td height="30" class="titulo_menu_site_bts">Área de Atua&ccedil;&atilde;o - PTB</td>
                <td class="titulo_noticias_home"><input name="AreaAtuacao_ptb" id="AreaAtuacao_ptb" type="text" class="admin_txtfield_login" size="30" value="<%=AreaAtuacao_ptb%>" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Área de Atua&ccedil;&atilde;o - ENG</td>
                <td class="titulo_noticias_home"><input name="AreaAtuacao_eng" id="AreaAtuacao_eng" type="text" class="admin_txtfield_login" size="30" value="<%=AreaAtuacao_eng%>" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Área de Atua&ccedil;&atilde;o - ESP</td>
                <td class="titulo_noticias_home"><input name="AreaAtuacao_esp" id="AreaAtuacao_esp" type="text" class="admin_txtfield_login" size="30" value="<%=AreaAtuacao_esp%>" /></td>
              </tr>
              <tr>
