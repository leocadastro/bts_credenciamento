...
'	response.write("<hr>" & SQL_Listar & "<hr>")
	...
	Else
		ramo_ptb 	= RS_Listar("ramo_ptb")
		ramo_eng	= RS_Listar("ramo_eng")
		ramo_esp	= RS_Listar("ramo_esp")
  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Ramo ID: <%=id%></span></td>
      ...
      <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <input type="hidden" id="acao" name="acao" value="upd_ramo">
            <input type="hidden" id="id" name="id" value="<%=id%>">
              ...
              <tr>
                ...
                <td class="titulo_noticias_home"><input name="ramo_ptb" id="ramo_ptb" type="text" class="admin_txtfield_login" size="30" value="<%=ramo_ptb%>" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Ramo - ENG</td>
                <td class="titulo_noticias_home"><input name="ramo_eng" id="ramo_eng" type="text" class="admin_txtfield_login" size="30" value="<%=ramo_eng%>" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Ramo - ESP</td>
                <td class="titulo_noticias_home"><input name="ramo_esp" id="ramo_esp" type="text" class="admin_txtfield_login" size="30" value="<%=ramo_esp%>" /></td>
              </tr>
              <tr>
                ...
                <td class="titulo_noticias_home">
                  <select id="atividade" name="atividade" class="admin_txtfield_login">
                    <option value="1" <% If atividade = "1" OR atividade = true Then %> selected <% End If %> >Sim</option>
                    <option value="0" <% If atividade = "0" OR atividade = false Then %> selected <% End If %> >Não</option>
                  </select>
                  </td>
              </tr>
              <tr>
