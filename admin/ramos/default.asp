  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Ramos</span></td>
        <td width="250" align="center" valign="middle" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;">
	        <a href="/admin/rel_edicoes_ramos/"><img src="/admin/images/bt_link.png" height="48" border="0" style="float: left; margin-top: -5px;"/>
            <div id="relacionamento_link">Relacionar Ramos</div></a>
        </td>
        ...
        <tr>
          ...
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <input type="hidden" id="acao" name="acao" value="add_Ramo">
              ...
              <tr>
                <td width="260" height="30" class="titulo_menu_site_bts">Possui Atividade</td>
                <td class="titulo_noticias_home">
                  <select id="atividade" name="atividade" class="admin_txtfield_login">
		...
		%>
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="fs11px t_arial">
              <tr>
                ...
                <td width="65" align="center" class="borda_dir linha_16px"><b>Possui Atividade</b></td>
            ...
            %>
              <tr bgcolor="#FFFFFF" 
                ...
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Ramo")%>';" align="left"><%=RS_Listar("ID_Ramo")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Ramo")%>';" align="left"><%=Rs_listar("ramo_PTB")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Ramo")%>';" align="left"><%=Rs_listar("ramo_ENG")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Ramo")%>';" align="left"><%=Rs_listar("ramo_ESP")%></td>
                <td class="borda_dir linha_16px " align="center">
                <%
					atividade = Rs_listar("atividade")
					If atividade = true OR atividade = 1 Then
                ...
                <%
					...
					If ativo = true OR ativo = 1 Then
						%><img src="/img/geral/icones/ok.gif" width="20" height="20" alt="ativo" title="ativo" onClick="document.location = 'metodos.asp?id=<%=Rs_listar("ID_Ramo")%>&acao=desativar';"><%
					Else
						%><img src="/img/geral/icones/nok.gif" width="20" height="20" alt="desativado" title="desativado" onClick="document.location = 'metodos.asp?id=<%=Rs_listar("ID_Ramo")%>&acao=ativar';"><%
                	End If
				%>
                </td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Ramo")%>';" align="left"><%=FormatDateTIme(Rs_listar("Data_Cadastro"),2)%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Ramo")%>';" align="center"><img src="/admin/images/ico_pg_prox.gif" width="15" height="15" alt="Ver Expositor" title="Ver Expositor" border="0"></td>
              </tr>
              <%
                RS_Listar.MoveNext()
            Wend
