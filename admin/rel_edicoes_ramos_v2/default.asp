...
Conexao.Open Application("cnn")
	...
	SQL_Listar = 	"Select DISTINCT " &_
					...
					"Left Join Administradores as A ON A.ID_Admin = Rer.ID_Admin " &_
					"Inner Join Eventos_Edicoes as Ee ON Ee.ID_Edicao = Rer.ID_Edicao " &_
					"Inner Join Eventos as E ON E.ID_Evento = Ee.ID_Evento " &_
  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Relacionar Ramos - Edi&ccedil;&otilde;es V2</span></td>
        <td width="250" align="center" valign="middle" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;">
	        <a href="/admin/ramos_v2/"><img src="/admin/images/bt_link.png" height="48" border="0" style="float: left; margin-top: -5px;"/>
            <div id="relacionamento_link">Cadastro de Ramos V2</div></a>
        </td>
