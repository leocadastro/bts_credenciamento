...
Select Case Acao
	...
	Case "menus_relacionar"
		...
		SQL_Del_1 =	"Delete From Relacionamento_RamoeAtividade_Edicoes_V2 " &_
					"Where " &_
					"	id_edicao = " & id_edicao
		...
		For i = 0 to Ubound(ramos)
			SQL_Inserir =	"Insert Into Relacionamento_RamoeAtividade_Edicoes_V2 " &_
							"(id_edicao, id_ramo_atividade, id_admin) " &_
							"Values " &_
...
'			response.write(SQL_Inserir & "<hr>")
		...
		Next
		response.Redirect("editar.asp?msg=add_ok&id_edicao=" & id_edicao)
	'==================================================
End Select
