...
Select Case Acao
	...
	Case "menus_relacionar"
		cargo 		= Split( Trim(Request("id_cargo")) )
		id_edicao	= Request("id_edicao")
		
		'1 - Remover todos Atualmente Relacionados
		SQL_Del_1 =	"Delete From Relacionamento_Edicoes_Cargo " &_
					"Where " &_
					"	id_edicao = " & id_edicao
		...
		For i = 0 to Ubound(cargo)
			SQL_Inserir =	"Insert Into Relacionamento_Edicoes_Cargo " &_
							"(id_edicao, id_cargo, id_admin) " &_
							"Values " &_
