  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Relacionar Cargos - Edi&ccedil;&otilde;es<br>
      ...
      <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="260" height="30" colspan="2" align="center"><span style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;">Marque os Cargos Desejados</span></td>
                </tr>
              <tr>
                <td colspan="2">
                          ...
                          <table width="390" border="0" cellspacing="0" cellpadding="0" class="fs11px t_arial bold c_vermelho">
                            ...
                            <div style="height:380px; overflow:auto;" id="lista_contato">
                              <table id="lista_menus" width="390" border="0" cellspacing="0" cellpadding="0" class="admin_tela_login">
                                <%
								If not RS_Cargos.BOF or RS_Cargos.EOF Then
									i = 0
									While not RS_Cargos.EOF
										checado = ""
										For w = Lbound(IDs) to Ubound(IDs)
											If Cstr(IDs(w)) = Cstr(RS_Cargos("id_cargo")) Then 
												checado = " checked "
												Exit For
											End If
										Next
										ativo = RS_Cargos("ativo")
										txt_desativado = ""
										...
										<td width="30" height="24" align="center"><input type="checkbox" name="id_cargo" id="id_cargo" value="<%=RS_Cargos("id_cargo")%>" <%=checado%>></td>
                                        <td onClick="check(<%=i%>);" class="cursor"><%=RS_Cargos("Cargo_PTB")%> <%=txt_desativado%></td>
                                        </tr>
                                    	<%
										RS_Cargos.MoveNext
										i = i + 1
