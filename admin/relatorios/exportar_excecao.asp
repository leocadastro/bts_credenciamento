    ...
    <table width="900" border="0" cellspacing="0" cellpadding="0">
      ...
      <div id="aviso" style="background-color:#FFFF00; width:100%; text-align:center;" class="t_arial fs11px bold c_preto"> <img src="/admin/images/ico_aviso.gif" alt="Aviso" width="20" height="20" hspace="2" vspace="4" align="absmiddle" title="Aviso"> <span id="aviso_conteudo">Aviso Processando, por favor não interrompa.</span></div>
		...
		SQL_1_RelacionamentoCadastros =		"SELECT " &_
											...
											" And RC.ID_Idioma <> 1"
											'" And ID_Relacionamento_Cadastro in (236104,239498,241432,241907,243112,252476,252825,252832,257604,260729,260743,263004)"
...
'			StartTime = Timer()
		...
		arquivo = "pre_credenciados_internacionais"
...
'				End If
	...
	%>
        ...
        <big style="background-color:#FF0;"><a href="/admin/exportar_xml/arquivos_2013/<%=Filename%>" target="_blank">Clique aqui * para salvar o arquivo.</a></big>&nbsp;* Botão direito > Salvar Como	<br>
