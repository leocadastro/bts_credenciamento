...
'			StartTime = Timer()
		...
		oFiletxt.WriteLine("<td>Ramos</td>")
		oFiletxt.WriteLine("<td>Atividadades</td>")
...
'response.write("<hr><b>SQL_2_Visitantes</b><br>" & SQL_2_Visitantes & "<br>")
			...
			If IDs(x)(5) <> "4" AND Len(Trim(IDs(x)(4))) > 0 Then
				...
				If not RS_8_Empresa_Ramos.BOF or not RS_8_Empresa_Ramos.EOF Then
					While not RS_8_Empresa_Ramos.EOF
						...
						If not RS_8_Empresa_Ramos.EOF Then Ramos = Ramos & "; "
					Wend
				...
				'======================================================
				SQL_9_Empresa_Atividades = 	"Select " &_
											"	* " &_
											"From Vw_Atividades " &_
											"Where  " &_
											"	ID_Empresa = " & IDs(x)(4)
					
				Set RS_9_Empresa_Atividades = Server.CreateObject("ADODB.RecordSet")
				RS_9_Empresa_Atividades.CursorLocation = 3
				RS_9_Empresa_Atividades.CursorType = 3
				RS_9_Empresa_Atividades.LockType = 1
				RS_9_Empresa_Atividades.Open SQL_9_Empresa_Atividades, Conexao
				'======================================================
				
				'======================================================
				Atividadades = ""
				If not RS_9_Empresa_Atividades.BOF or not RS_9_Empresa_Atividades.EOF Then
					While not RS_9_Empresa_Atividades.EOF
						Atividade_Outro	= RS_9_Empresa_Atividades.Fields("Atividade_Outros").Value
						Atividadade		= RS_9_Empresa_Atividades.Fields("Atividade").Value
						' Se virer Outros
						If Len(Trim(Atividade_Outro)) > 0  Then
							Atividadades 		= Atividadades & "Outros: " & Atividade_Outro
						Else
							' Nao exibir OUTROS
							If Atividadade <> "Outros" Then
								Atividadades 		= Atividadades & Atividadade
							End If
						End If
						RS_9_Empresa_Atividades.MoveNext
						If not RS_9_Empresa_Atividades.EOF Then Atividadades = Atividadades & "; "
					Wend
					RS_9_Empresa_Atividades.Close
					Set RS_9_Empresa_Atividades = Nothing
				End If
				'======================================================
			...
			If not RS_2_Visitantes.BOF or not RS_2_Visitantes.EOF Then
				...
				oFiletxt.WriteLine("<tr>")
					...
					oFiletxt.WriteLine("<td nowrap>" & trocar(Ucase( Ramos )) & "</td>")
					oFiletxt.WriteLine("<td nowrap>" & trocar(Ucase( Atividadades )) & "</td>")
