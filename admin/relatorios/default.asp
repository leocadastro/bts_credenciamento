...
menu(2) = Array("Total de Pré-Credenciados por Tipo - Semanal", "spacer", "document.location='/admin/relatorios/relatorio_total_precredenciados_semanal.asp';", "1,2,3")
menu(3) = Array("Exportar Pré-Credenciados", "spacer", "document.location='/admin/relatorios/exportar_precredenciados.asp';", "1,2")
menu(4) = Array("Exportar p/ CORREIOS - Pré-Credenciados", "spacer", "document.location='/admin/relatorios/exportar_precredenciados_correio.asp';", "1,2")
menu(5) = Array("Compra de Ingressos - ABF", "spacer", "document.location='/admin/relatorios/relatorio_ingressos.asp?ID_Evento=5&ano_pedido=2015';", "1,2,3")
menu(6) = Array("Relatório de Alunos - Por Evento", "spacer", "document.location='/admin/relatorios/relatorio_alunos.asp';", "1,2,3")
menu(7) = Array("Compra de Ingressos - ABF Nordeste", "spacer", "document.location='/admin/relatorios/relatorio_ingressos.asp?ID_Evento=16';", "1,2,3")
      ...
      <table width="560" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="50" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center">Menu Principal <br>
            <span class="fs10px c_azul1">Dica: navegue digitando o n&uacute;mero correspondente</span>
			<%
            ...
            <tr>
            <td style="color:#F00; font-weight:bolder; font-size:15px;">A página solicitada esta passando por manutenção, por favor, volte mais tarde.</td>
            </tr>
            </table>
            <%
            end if
