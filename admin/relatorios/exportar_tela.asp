<%
sub rw(s,b)
	'response.Write("<textarea style='width:300px; height:30px;'>"&s&"</textarea>")
	'if b then
	'	response.End()
	'end if
end sub
...
'			StartTime = Timer()
		...
		Response.Write("<tr>")
		Response.Write("<td rowspan='3'>N</td>")
		Response.Write("<td rowspan='3'>ID_Cadastro</td>")
		Response.Write("<td rowspan='3'>ID_Visitante</td>")
		Response.Write("<td rowspan='3'>ID_Empresa</td>")
		Response.Write("<td rowspan='3'>ID_Formulario</td>")
		Response.Write("<td rowspan='3'>Data_Cadastro</td>")
		
		Response.Write("<td rowspan='3'>Empresa_CNPJ</td>")
		Response.Write("<td rowspan='3'>Empresa_Razao_Social</td>")
		Response.Write("<td rowspan='3'>Empresa_Nome_Fantasia</td>")
		Response.Write("<td rowspan='3'>Empresa_Qtde_Funcionarios</td>")
		Response.Write("<td rowspan='3'>Empresa_Principal_Produto</td>")
		Response.Write("<td rowspan='3'>Ramos e Atividades</td>")
		Response.Write("<td rowspan='3'>Ramos Outros</td>")
		Response.Write("<td rowspan='3'>Atividades Outros</td>")
		Response.Write("<td rowspan='3'>InteresseFeira</td>")
		Response.Write("<td rowspan='3'>Empresa_Site</td>")
		Response.Write("<td rowspan='3'>Empresa_Presidente</td>")
		Response.Write("<td rowspan='3'>Empresa_Reitor</td>")

		Response.Write("<td rowspan='3'>Empresa_Tipo_Telefone</td>")
		Response.Write("<td rowspan='3'>Empresa_DDI</td>")
		Response.Write("<td rowspan='3'>Empresa_DDD</td>")
		Response.Write("<td rowspan='3'>Empresa_Numero</td>")					
		Response.Write("<td rowspan='3'>Empresa_Ramal</td>")
		Response.Write("<td rowspan='3'>Empresa_SMS</td>")

		Response.Write("<td rowspan='3'>CPF</td>")
		Response.Write("<td rowspan='3'>Passaporte</td>")
		Response.Write("<td rowspan='3'>Nome_Completo</td>")
		Response.Write("<td rowspan='3'>Nome_Credencial</td>")
		Response.Write("<td rowspan='3'>Data_Nasc</td>")
		Response.Write("<td rowspan='3'>Sexo</td>")
		Response.Write("<td rowspan='3'>Email</td>")
		Response.Write("<td rowspan='3'>Newsletter</td>")
		
		Response.Write("<td rowspan='3'>Visitante_Tipo_Telefone 1</td>")
		Response.Write("<td rowspan='3'>Visitante_DDI 1</td>")
		Response.Write("<td rowspan='3'>Visitante_DDD 1</td>")
		Response.Write("<td rowspan='3'>Visitante_Numero 1</td>")					
		Response.Write("<td rowspan='3'>Visitante_Ramal 1</td>")
		Response.Write("<td rowspan='3'>Visitante_SMS 1</td>")
		
		Response.Write("<td rowspan='3'>Visitante_Tipo_Telefone 2</td>")
		Response.Write("<td rowspan='3'>Visitante_DDI 2</td>")
		Response.Write("<td rowspan='3'>Visitante_DDD 2</td>")
		Response.Write("<td rowspan='3'>Visitante_Numero 2</td>")					
		Response.Write("<td rowspan='3'>Visitante_Ramal 2</td>")
		Response.Write("<td rowspan='3'>Visitante_SMS 2</td>")
									
		Response.Write("<td rowspan='3'>Cargo</td>")
		Response.Write("<td rowspan='3'>Cargo_Outros</td>")
		Response.Write("<td rowspan='3'>SubCargo</td>")
		Response.Write("<td rowspan='3'>SubCargo_Outros</td>")
		Response.Write("<td rowspan='3'>Depto</td>")
		Response.Write("<td rowspan='3'>Depto_Outros</td>")
		
		Response.Write("<td rowspan='3'>Endereco_CEP</td>")
		Response.Write("<td rowspan='3'>Endereco_Endereco</td>")
		Response.Write("<td rowspan='3'>Endereco_Numero</td>")
		Response.Write("<td rowspan='3'>Endereco_Complemento</td>")
		Response.Write("<td rowspan='3'>Endereco_Bairro</td>")
		Response.Write("<td rowspan='3'>Endereco_Cidade</td>")
		Response.Write("<td rowspan='3'>Endereco_UF</td>")
		Response.Write("<td rowspan='3'>Endereco_Pais</td>")
		...
		SQL_1_Perguntas_Itens =		"Select " &_
											...
											"	P.Multiplo " &_
											"From  " &_
											"	Relacionamento_Edicoes_Pergunta as REP  (NOLOCK) " &_
											"Inner Join " &_
											"	Perguntas as P  (NOLOCK) " &_
											"	On REP.ID_Pergunta = P.ID_Perguntas " &_
											"Where  " &_
											"	REP.ID_Edicao = " & id_edicao & " " &_
											"	And P.Ativo <> 10 " &_
											" " & Where_Perguntas & " " &_
											"Order By P.ID_Formulario ASC "
		...
		If not RS_1_Perguntas_Itens.BOF or not RS_1_Perguntas_Itens.EOF Then
			...
			Response.Write("<td colspan='" & colspan_cabecalho1 & "'>Perguntas e Respostas</td>")
			...
			SQL_TipoFormularios = 	"Select " &_
									...
									"	Perguntas as P  (NOLOCK) " &_
									"	On REP.ID_Pergunta = P.ID_Perguntas " &_
									"Inner Join Formularios as F  (NOLOCK) " &_
									...
									'response.write(SQL_TipoFormularios)
			...
			If not RS_TipoFormularios.BOF or not RS_TipoFormularios.EOF Then
				...
				While not RS_TipoFormularios.EOF
					...
					Response.Write("<td colspan='" & Qtde_Formulario_Perguntas & "' nowrap>" & Nome_Formulario_Perguntas & "</td>")
			...
			If not RS_1_Perguntas_Itens.BOF or not RS_1_Perguntas_Itens.EOF Then
				...
				While not RS_1_Perguntas_Itens.EOF
					...
					Response.Write("<td nowrap>" & RS_1_Perguntas_Itens.Fields("Pergunta_PTB").Value & "</td>")
...
'				End If
			...
			If not RS_2_Visitantes.BOF or not RS_2_Visitantes.EOF Then
				...
				' MASCARA DE CEP
				If ((Len(Trim(Endereco_CEP)) > 0 And idioma = "1") or (Endereco_Pais = "Brasil")) Then
				...
				Response.Write("<tr>")
					Response.Write("<td nowrap>" & i & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( ID_Cadastro )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( ID_Visitante )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( id_empresa )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( formulario )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( data_cadastro )) & "</td>")
					
					Response.Write("<td nowrap>" & Empresa_CNPJ_MASK & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Empresa_Razao_Social )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Empresa_Nome_Fantasia )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Empresa_Qtde_Funcionarios )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Empresa_Principal_Produto )) & "</td>")
					...
					If qtde_ramos > 0 Then
						...
						while w < Ubound(Ramos_Atividades)
							...
							sRamAtiv0=sRamAtiv0 & trocar(Ucase( arrRamAtiv(0) ))&";"
							sRamAtiv1=sRamAtiv1 & trocar(Ucase( arrRamAtiv(1) ))&";"
							w=w+1
						wend
						Response.Write("<td nowrap>" & sRamAtiv0 & "</td>")
						Response.Write("<td nowrap>" & sRamAtiv1 & "</td>")
					...
					Response.Write("<td nowrap>" & trocar(Ucase( Atividadades_Outros )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( InteresseFeira )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Empresa_Site )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Empresa_Presidente )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Empresa_Reitor )) & "</td>")

					Response.Write("<td nowrap>" & trocar(Ucase( Empresa_Tipo_Telefone )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Empresa_DDI )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Empresa_DDD )) & "</td>")
					Response.Write("<td nowrap>" & limpar_formatacao(trocar(Ucase( Empresa_Numero ))) & "</td>")					
					Response.Write("<td nowrap>" & trocar(Ucase( Empresa_Ramal )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Empresa_SMS )) & "</td>")

					Response.Write("<td nowrap>" & CPF_MASK & "</td>")
					Response.Write("<td nowrap>'" & trocar(Ucase( Passaporte )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Nome_Completo )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Nome_Credencial )) & "</td>")
					Response.Write("<td nowrap>" & Data_Nasc_MASK & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Sexo )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Email )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Newsletter )) & "</td>")

					Response.Write("<td nowrap>" & trocar(Ucase( Visitante_Telefones(0)(0) )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Visitante_Telefones(0)(1) )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Visitante_Telefones(0)(2) )) & "</td>")
					Response.Write("<td nowrap>" & limpar_formatacao(trocar(Ucase( Visitante_Telefones(0)(3) ))) & "</td>")					
					Response.Write("<td nowrap>" & trocar(Ucase( Visitante_Telefones(0)(4) )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Visitante_Telefones(0)(5) )) & "</td>")
					
					If Ubound(Visitante_Telefones) > 1 Then
						Response.Write("<td nowrap>" & trocar(Ucase( Visitante_Telefones(1)(0) )) & "</td>")
						Response.Write("<td nowrap>" & trocar(Ucase( Visitante_Telefones(1)(1) )) & "</td>")
						Response.Write("<td nowrap>" & trocar(Ucase( Visitante_Telefones(1)(2) )) & "</td>")
						Response.Write("<td nowrap>" & limpar_formatacao(trocar(Ucase( Visitante_Telefones(1)(3) ))) & "</td>")
						Response.Write("<td nowrap>" & trocar(Ucase( Visitante_Telefones(1)(4) )) & "</td>")
						Response.Write("<td nowrap>" & trocar(Ucase( Visitante_Telefones(1)(5) )) & "</td>")
					Else
					...
					Response.Write("<td nowrap>" & trocar(Ucase( Cargo )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Cargo_Outros )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( SubCargo )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( SubCargo_Outros )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Depto )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Depto_Outros )) & "</td>")
					
					Response.Write("<td nowrap>" & Endereco_CEP_MASK & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Endereco_Endereco )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Endereco_Numero )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Endereco_Complemento )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Endereco_Bairro )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Endereco_Cidade )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Endereco_UF )) & "</td>")
					Response.Write("<td nowrap>" & trocar(Ucase( Endereco_Pais )) & "</td>")
					...
					For id_perg = Lbound(Array_ID_Perguntas)+1 To Ubound(Array_ID_Perguntas)
						...
						SQL_Listar_Resposta_Pergunta_por_Item = 	"Select Distinct " &_
																	...
																	"From Relacionamento_Perguntas as RP  (NOLOCK) " &_
																	"Inner Join Perguntas_Opcoes as PO  (NOLOCK) " &_
						...
						'response.write("<hr><b>SQL_Listar_Resposta_Pergunta_por_Item</b><hr><hr><br>" & SQL_Listar_Resposta_Pergunta_por_Item)
						...
						Else 
							SQL_Listar_Resposta_Pergunta_por_Item = "Select Distinct " &_
																	...
																	"Inner Join Perguntas_Opcoes as PO  (NOLOCK) " &_
																	"	On PO.ID_Opcoes = RP.ID_Opcoes " &_
																	"Inner Join Relacionamento_Edicoes_Pergunta as REP (NOLOCK) " &_
																	"	On RP.ID_Perguntas = REP.ID_Pergunta  " &_
																	"	AND ID_Edicao = " & id_edicao & " " &_
																	"Where  " &_
																	"	RP.ID_Relacionamento_Cadastro = " & IDs(x)(3) & " " &_
																	"	AND RP.ID_Perguntas = " & Array_ID_Perguntas(id_perg) & " " &_
																	" 	AND REP.ID_Formulario = " & formulario & " "
 
							'response.write("<b>Ubound(Array_ID_Perguntas)</b><br>" & Ubound(Array_ID_Perguntas))
							'response.write("<br><br><hr><b>SQL_Listar_Resposta_Pergunta_por_Item</b><br><br>" & SQL_Listar_Resposta_Pergunta_por_Item)
						...
						End If
						Response.Write("<td nowrap>" & trocar(Ucase( resposta_a_esta_pergunta )) & "</td>")
					Next
				Response.Write("</tr>")
