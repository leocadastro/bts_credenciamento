...
Conexao.Open Application("cnn")
	...
	SQL_Listar = 	"Select " &_
					...
					"Where " &_
					"	Pt.ID_Pagina = " & id & " " &_
					"Order by Pt.Ordem, Pt.ID_Idioma"
      ...
      <table width="900" border="0" cellpadding="0" cellspacing="0">
		...
		%>
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="fs11px t_arial">
              <tr>
                <td width="50" align="center" class="borda_dir linha_16px"><b>ID Texto</b></td>
                <td width="70" align="center" class="borda_dir linha_16px"><b>Idioma</b></td>
                <td class="borda_dir linha_16px" align="center"><b>Tipo</b></td>
                <td width="50" align="center" class="borda_dir linha_16px"><b>Ordem</b></td>
                <td width="100" align="center" class="borda_dir linha_16px"><b>Identificacao</b></td>
                <td width="150" align="center" class="borda_dir linha_16px"><b>Texto</b></td>
                <td class="borda_dir linha_16px" align="center"><b>Imagem</b></td>
                <td width="80" align="center" class="borda_dir linha_16px"><b>Atualizado <br>
                por -Data</b></td>
            ...
            %>
              <tr bgcolor="#FFFFFF" 
                ...
                <td class="borda_dir linha_16px" align="center"><%=RS_Listar("ID_Texto")%></td>
                <td class="borda_dir linha_16px" align="left"><%=RS_Listar("Idioma")%>&nbsp;</td>
                <td class="borda_dir linha_16px" align="left"><%=Rs_listar("Tipo")%></td>
                <td class="borda_dir linha_16px" align="center"><%=Rs_listar("Ordem")%></td>
                <td class="borda_dir linha_16px" align="left"><%=Rs_listar("Identificacao")%></td>
                <td class="borda_dir linha_16px" align="left"><%=Rs_listar("Texto")%></td>
                <td class="borda_dir linha_16px" align="left">
				<%
				If Rs_listar("URL_Imagem") <> "" Then
					%><img src="<%=Rs_listar("URL_Imagem")%>"><%
				Else
					%>-<%
				End If
				%>
				...
				<%
				If Rs_listar("Data_Atualizacao") <> "" Then
					%><%=FormatDateTime(Rs_listar("Data_Atualizacao"),2)%><%
				Else
					%><%=FormatDateTime(Rs_listar("Data"),2)%><%
				End If
				%>
                </td>
