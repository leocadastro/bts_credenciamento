      ...
      <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <input type="hidden" id="url" name="url" value="atualizar.asp">
            <input type="hidden" id="id" name="id" value="<%=id%>">
              ...
              <tr>
				...
				If not RS_Perfil.BOF or not RS_Perfil.EOF Then
					While not RS_Perfil.EOF
						selecionado = ""
						If Cint(id_perfil) = Cint(RS_Perfil("id_perfil")) Then 
              ...
              <tr>
                ...
                <td class="titulo_noticias_home"><input name="nova_senha" type="password" class="admin_txtfield_login" id="nova_senha" size="30" maxlength="15" /></td>
              </tr>
              <tr>
