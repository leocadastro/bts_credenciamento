  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Definir Acesso para &agrave;s Edi&ccedil;&otilde;es Abaixo</span></td>
        <td width="100" align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;"><a href="../editar.asp?id=<%=id%>"><img src="/admin/images/bt_voltar_admin.gif" width="100" height="48" border="0" /></a><a href="default.asp"></a></td>
      </tr>
    </table>
      ...
      <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="260" height="30" colspan="2" align="center"><span style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;">Marque as Edi&ccedil;&otilde;es Desejados</span></td>
                </tr>
              <tr>
                <td colspan="2">
                    ...
                    <form name="cad" id="cad" method="post" action="metodos.asp">
                      <div id="forms_hidden" style="position:fixed; left:-100px; top:-100px;">
                        <input type="hidden" id="acao" name="acao" value="usuario_relacionar" style="visibility:hidden; display:none;">
                        <input type="hidden" id="id_admin" name="id_admin" value="<%=id%>" style="visibility:hidden; display:none;">
                      </div>
                      <table width="420" border="0" cellpadding="0" cellspacing="5">
                        <tr>
                          ...
                          <table width="390" border="0" cellspacing="0" cellpadding="0" class="fs11px t_arial bold c_vermelho">
                            <tr>
                              <td colspan="2" align="center">Edi&ccedil;&atilde;o - Evento</td>
                            </tr>
                          </table>
                            <div style="height:380px; overflow:auto;" id="lista_contato">
                              <table id="lista_menus" width="390" border="0" cellspacing="0" cellpadding="0" class="admin_tela_login">
                                <%
								If not RS_Eventos.BOF or RS_Eventos.EOF Then
									i = 0
									While not RS_Eventos.EOF
										checado = ""
										For w = Lbound(IDs) to Ubound(IDs)
											If Cstr(IDs(w)) = Cstr(RS_Eventos("id_edicao")) Then 
												checado = " checked "
												Exit For
											End If
										Next
										...
										<td width="30" height="24" align="center"><input type="checkbox" name="id_edicao" id="id_edicao" value="<%=RS_Eventos("id_edicao")%>" <%=checado%>></td>
                                        <td onClick="check(<%=i%>);" class="cursor"><%=RS_Eventos("Ano")%> - <%=RS_Eventos("Evento")%></td>
                                        </tr>
                                    	<%
										RS_Eventos.MoveNext
										i = i + 1
