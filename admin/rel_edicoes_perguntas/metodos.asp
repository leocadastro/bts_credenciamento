...
id_form 		= Limpar_Texto(Request("id_form"))
...
Select Case Acao
	...
	Case "menus_relacionar"
		pergunta 		= Split( Trim(Request("id_perguntas")) )
		id_edicao	= Request("id_edicao")
		
		'1 - Remover todos Atualmente Relacionados
		SQL_Del_1 =	"Delete From Relacionamento_Edicoes_Pergunta " &_
					"Where " &_
					"	id_edicao = " & id_edicao & " " &_
					"And Id_Formulario = " & id_form
		'response.write(SQL_Del_1)
		Set RS_Del_1 = Server.CreateObject("ADODB.Recordset")
		RS_Del_1.Open SQL_Del_1, Conexao
	
		'3 - Loop para Relacionar cada Ramo
		For i = 0 to Ubound(pergunta)
			SQL_Inserir =	"Insert Into Relacionamento_Edicoes_Pergunta " &_
							"(id_edicao, ID_Pergunta, ID_Formulario, id_admin) " &_
							"Values " &_
							"(" & id_edicao & "," & Replace(pergunta(i),",","") & "," & id_form & ", " & Session("admin_id_usuario") & ")"
