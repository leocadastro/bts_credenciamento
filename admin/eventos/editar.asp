...
'	response.write("<hr>" & SQL_Listar & "<hr>")
	...
	Else
		...
		nome_eng = RS_Listar("nome_eng")
		nome_esp = RS_Listar("nome_esp")
      ...
      <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <input type="hidden" id="acao" name="acao" value="upd_evento">
            <input type="hidden" id="id" name="id" value="<%=id%>">
              ...
              <tr>
                ...
                <td class="titulo_noticias_home"><input name="nome_ptb" id="nome_ptb" type="text" class="admin_txtfield_login" size="30" value="<%=nome_ptb%>" /></td>
              </tr>
              <tr>
                <td width="260" height="30" class="titulo_menu_site_bts">Nome Evento - Engl.</td>
                <td class="titulo_noticias_home"><input name="nome_eng" id="nome_eng" type="text" class="admin_txtfield_login" size="30" value="<%=nome_eng%>" /></td>
              </tr>
              <tr>
                <td width="260" height="30" class="titulo_menu_site_bts">Nome Evento - Esp.</td>
                <td class="titulo_noticias_home"><input name="nome_esp" id="nome_esp" type="text" class="admin_txtfield_login" size="30" value="<%=nome_esp%>" /></td>
              </tr>
              <tr>
