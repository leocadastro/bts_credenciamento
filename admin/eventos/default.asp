      ...
      <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <input type="hidden" id="acao" name="acao" value="add_evento">
              <tr>
                <td height="30" colspan="2" align="center"><span style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;">Cadastrar Novo Evento</span></td>
              </tr>
              <tr>
                <td width="260" height="30" class="titulo_menu_site_bts">Nome Evento - Port.</td>
                <td class="titulo_noticias_home"><input name="nome_ptb" id="nome_ptb" type="text" class="admin_txtfield_login" size="30" /></td>
              </tr>
              <tr>
                <td width="260" height="30" class="titulo_menu_site_bts">Nome Evento - Engl.</td>
                <td class="titulo_noticias_home"><input name="nome_eng" id="nome_eng" type="text" class="admin_txtfield_login" size="30" /></td>
              </tr>
              <tr>
                <td width="260" height="30" class="titulo_menu_site_bts">Nome Evento - Esp.</td>
                <td class="titulo_noticias_home"><input name="nome_esp" id="nome_esp" type="text" class="admin_txtfield_login" size="30" /></td>
              </tr>
              <tr>
		...
		%>
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="fs11px t_arial">
              <tr>
                ...
                <td class="borda_dir linha_16px" align="center"><b>Nome_PTB</b></td>
                <td class="borda_dir linha_16px" align="center"><b>Nome_ENG</b></td>
                <td class="borda_dir linha_16px" align="center"><b>Nome_ESP</b></td>
            ...
            %>
              <tr bgcolor="#FFFFFF" 
                ...
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Evento")%>';" align="left"><%=RS_Listar("ID_Evento")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Evento")%>';" align="left"><%=Rs_listar("Nome_PTB")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Evento")%>';" align="left"><%=Rs_listar("Nome_ENG")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Evento")%>';" align="left"><%=Rs_listar("Nome_ESP")%></td>
                <td class="borda_dir linha_16px cursor" align="center">
                <%
					ativo = Rs_listar("Ativo")
					If ativo = true OR ativo = 1 Then
						%><img src="/img/geral/icones/ok.gif" width="20" height="20" alt="ativo" title="ativo" onClick="document.location = 'metodos.asp?id=<%=Rs_listar("ID_Evento")%>&acao=desativar';"><%
					Else
						%><img src="/img/geral/icones/nok.gif" width="20" height="20" alt="desativado" title="desativado" onClick="document.location = 'metodos.asp?id=<%=Rs_listar("ID_Evento")%>&acao=ativar';"><%
                	End If
				%>
                </td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Evento")%>';" align="left"><%=Rs_listar("Data_Cadastro")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Evento")%>';" align="center"><img src="/admin/images/ico_pg_prox.gif" width="15" height="15" alt="Ver Expositor" title="Ver Expositor" border="0"></td>
              </tr>
              <%
                RS_Listar.MoveNext()
            Wend
