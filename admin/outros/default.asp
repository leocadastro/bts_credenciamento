...
'  ( 0 - 1 ) 
'  ( 2 - 3 ) ...
menu(0) = Array("Ramos", "spacer", "document.location='/admin/outros/listar.asp?tab=ramo';", "1,2")
menu(1) = Array("Atividades", "spacer", "document.location='/admin/outros/listar.asp?tab=atividade';", "1,2,3")
menu(2) = Array("Subcargos", "spacer", "document.location='/admin/outros/subcargos.asp';", "1,2,3")
%>
