...
Conexao.Open Application("cnn")
	...
	Else
		ID	 				= RS_Listar("ID_Visitante")
		Empresa 			= RS_Listar("Empresa")
		Visitante 			= RS_Listar("Nome_Completo")
		Produto			 	= RS_Listar("SubCargo_Outros")
...
function voltar() {
	...
	if (confirmacao) {
		document.location = 'subcargos.asp';	
	}
}
</script>
        ...
        <tr>
          ...
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            <form id="cad" name="cad" method="post" action="metodos.asp?tab=<%=tabela%>">
              ...
              <input type="hidden" id="acao" name="acao" value="atualizar_subcargo">
              <tr>
              ...
              <tr>
                ...
                <td class="titulo_noticias_home"><%=Visitante%></td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="30" class="titulo_menu_site_bts">Subcargo</td>
