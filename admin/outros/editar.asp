...
Conexao.Open Application("cnn")
	...
	SQL_Listar = 	"Select " &_
					...
					"Where Tab.ID_Relacionamento_" & campo_tabela & " = " & id
	...
	Else
		ID	 				= RS_Listar("ID_Relacionamento_" & campo_tabela)
		Empresa 			= RS_Listar("Empresa")
		Produto			 	= RS_Listar(campo_tabela & "_Outros")
...
function voltar() {
	...
	if (confirmacao) {
		document.location = 'listar.asp?tab=<%=tabela%>';	
	}
}
</script>
    ...
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="100" align="center" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;">
        	<a href="javascript:voltar();"><img src="/admin/images/bt_voltar_admin.gif" width="100" height="48" border="0" /></a>
        </td>
      </tr>
    </table>
      ...
      <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            <form id="cad" name="cad" method="post" action="metodos.asp?tab=<%=tabela%>">
              ...
              <tr>
                ...
                <td class="titulo_noticias_home"><%=Empresa%></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts"><%=campo_tabela%></td>
                <td class="titulo_noticias_home"><input type="text" class="admin_txtfield_login" size="30" maxlength="255" value="<%=Produto%>" name="registro" id="registro"/></td>
              </tr>
              <tr>
