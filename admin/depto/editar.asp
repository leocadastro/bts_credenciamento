...
'	response.write("<hr>" & SQL_Listar & "<hr>")
	...
	Else
		Depto_ptb 	= RS_Listar("Depto_ptb")
		Depto_eng	= RS_Listar("Depto_eng")
		Depto_esp	= RS_Listar("Depto_esp")
  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Depto ID: <%=id%></span></td>
      ...
      <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <input type="hidden" id="acao" name="acao" value="upd_Depto">
            <input type="hidden" id="id" name="id" value="<%=id%>">
              ...
              <tr>
                ...
                <td class="titulo_noticias_home"><input name="Depto_ptb" id="Depto_ptb" type="text" class="admin_txtfield_login" size="30" value="<%=Depto_ptb%>" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Depto - ENG</td>
                <td class="titulo_noticias_home"><input name="Depto_eng" id="Depto_eng" type="text" class="admin_txtfield_login" size="30" value="<%=Depto_eng%>" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Depto - ESP</td>
                <td class="titulo_noticias_home"><input name="Depto_esp" id="Depto_esp" type="text" class="admin_txtfield_login" size="30" value="<%=Depto_esp%>" /></td>
              </tr>
              <tr>
