		...
		%>
            ...
            %>
              <tr bgcolor="#FFFFFF" 
                ...
                <td class="borda_dir linha_16px" align="center"><a href="editar.asp?id=<%=Rs_listar("ID_Pagina")%>"><img src="/admin/images/ico_editar.gif" width="20" height="20" alt="Editar Página" title="Editar Página" border="0"></a>&nbsp;&nbsp;<a href="/admin/paginas_textos/default.asp?id=<%=Rs_listar("ID_Pagina")%>"><img src="/admin/images/ico_adicionar.gif" width="20" height="20" alt="Adicionar Texto" title="Adicionar Texto" border="0"></a></td>
              </tr>
              <%
                RS_Listar.MoveNext()
            Wend
