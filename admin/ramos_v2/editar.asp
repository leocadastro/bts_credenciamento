...
'	response.write("<hr>" & SQL_Listar & "<hr>")
	...
	Else
		ramo_ptb 	= RS_Listar("ramo_atv_ptb")
		ramo_eng	= RS_Listar("ramo_atv_eng")
		ramo_esp	= RS_Listar("ramo_atv_esp")
  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Ramo V2 ID: <%=id%></span></td>
              ...
              <tr>
                ...
                <td class="titulo_noticias_home">
                  <select id="complemento" name="complemento" class="admin_txtfield_login">
                    <option value="1" <% If complemento = "1" OR complemento = true Then %> selected <% End If %> >Sim</option>
                    <option value="0" <% If complemento = "0" OR complemento = false Then %> selected <% End If %> >Não</option>
                  </select>
                  </td>
              </tr>
              <tr>
