  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Tipos de Credenciamento</span></td>
      ...
      <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <input type="hidden" id="acao" name="acao" value="add_tipo_cred">
              <tr>
              ...
              <tr>
				...
				If not RS_Idioma.BOF or not RS_Idioma.EOF Then
					...
					%><option value="<%=RS_Idioma("ID_Idioma")%>"><%=RS_Idioma("Nome")%></option><%
						RS_Idioma.MoveNext
					Wend
					RS_Idioma.Close
				End If
              ...
              <tr>
                ...
                <td class="titulo_noticias_home"><input name="img_faixa" id="img_faixa" type="text" class="admin_txtfield_login" size="30"  value="/img/geral/tipos/" />
                  <img src="/admin/images/ico_preview_20_b.gif" alt="Visualizar Imagem" title="Visualizar Imagem" class="cursor" onClick="window.open($('#img_faixa').val());" width="20" height="20" align="absmiddle"></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Imagem Box</td>
                <td class="titulo_noticias_home"><input name="img_box" id="img_box" type="text" class="admin_txtfield_login" size="30"  value="/img/geral/tipos/" />
                  <img src="/admin/images/ico_preview_20_b.gif" alt="Visualizar Imagem" title="Visualizar Imagem" class="cursor" onClick="window.open($('#img_box').val());" width="20" height="20" align="absmiddle"></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">URL do Formul&aacute;rio</td>
                <td class="titulo_noticias_home"><input name="url" id="url" type="text" class="admin_txtfield_login" size="30"  value="/pasta_" /></td>
              </tr>
              <tr>
		...
		%>
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="fs11px t_arial">
              <tr>
                ...
                <td align="center" class="borda_dir linha_16px"><b>Nome</b></td>
                <td align="center" class="borda_dir linha_16px"><b>Idioma</b></td>
                <td align="center" class="borda_dir linha_16px"><b>Imagem Faixa</b></td>
                <td align="center" class="borda_dir linha_16px"><b>Imagem Box</b></td>
                <td align="center" class="borda_dir linha_16px"><b>URL do Formul&aacute;rio.</b></td>
                <td width="65" align="center" class="borda_dir linha_16px"><b>Dispon&iacute;vel</b></td>
            ...
            %>
              <tr bgcolor="#FFFFFF" 
                ...
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Tipo_Credenciamento")%>';" align="center"><%=Rs_listar("ID_Tipo_Credenciamento")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Tipo_Credenciamento")%>';" align="left"><%=Rs_listar("Nome")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Tipo_Credenciamento")%>';" align="left"><%=Rs_listar("Idioma")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Tipo_Credenciamento")%>';" align="left"><img src="<%=Rs_listar("IMG_Faixa")%>"></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Tipo_Credenciamento")%>';" align="left"><img src="<%=Rs_listar("IMG_Box")%>"></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Tipo_Credenciamento")%>';" align="left"><%=Rs_listar("URL")%></td>
                <td align="center" class="borda_dir linha_16px cursor">
				<%
                ativo = Rs_listar("Ativo")
                If ativo = true OR ativo = 1 Then
					%>
					<img src="/img/geral/icones/ok.gif" width="20" height="20" alt="ativo" title="ativo" onClick="document.location = 'metodos.asp?id=<%=Rs_listar("ID_Tipo_Credenciamento")%>&acao=desativar';">
					<%
                Else
					%>
					<img src="/img/geral/icones/nok.gif" width="20" height="20" alt="desativado" title="desativado" onClick="document.location = 'metodos.asp?id=<%=Rs_listar("ID_Tipo_Credenciamento")%>&acao=ativar';">
					<%
                End If
                %>
                </td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Tipo_Credenciamento")%>';" align="left"><%=Rs_listar("Data")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_Tipo_Credenciamento")%>';" align="center"><img src="/admin/images/ico_pg_prox.gif" width="15" height="15" alt="Ver Expositor" title="Ver Expositor" border="0"></td>
              </tr>
              <%
                RS_Listar.MoveNext()
            Wend
