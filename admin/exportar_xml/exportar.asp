...
'										"WHERE ID_Empresa='85531' AND ID_Edicao = " & id_edicao
		'response.write(SQL_1_RelacionamentoCadastros)
...
'response.write("<hr><b>SQL_2_Visitantes</b><br>" & SQL_2_Visitantes & "<br>")
			...
			response.write SQL_2_Visitantes
			response.end
			...
			' INICIO - Correcao do retorno das Perguntas Pelo ID_Visitante
			'==================================================

			SQL_11_Perguntas = 	"SELECT " &_ 
								"	RP.ID_Relacionamento_Cadastro, " &_ 
								"	P.Pergunta_PTB AS Pergunta, " &_ 
								"	PO.Opcao_PTB AS Resposta " &_ 
								"FROM " &_ 
								"	Relacionamento_Perguntas AS RP " &_ 
								"		INNER JOIN " &_ 
								"			Perguntas AS P ON P.ID_Perguntas = RP.ID_Perguntas " &_ 
								"		INNER JOIN " &_ 
								"			Perguntas_Opcoes AS PO ON PO.ID_Opcoes = RP.ID_Opcoes " &_ 
								"		INNER JOIN " &_ 
								...
								"WHERE " &_ 
								"	ID_Relacionamento_Cadastro = " & IDs(x)(0) & " " &_
								"	ORDER BY RP.ID_Perguntas "

			'==================================================
			' FIM - Correcao do retorno das Perguntas Pelo ID_Visitante
			'==================================================
			...
			If not RS_11_Perguntas.BOF or not RS_11_Perguntas.EOF Then
				...
				While not RS_11_Perguntas.EOF
					...
					ElseIf Trim(Pergunta_OLD) = Trim(Pergunta_Atual) Then
						...
						'==================================================
						' Nova Implementacao - 18/06/2014 - Leandro Santiago | HD 8901
						' INICIO - Correcao do retorno das respostas repetidas
						'==================================================
						VR_Resposta		= 0
						VRespostas 		= ""

						vRespostas = split(Todas_Respostas,";")

						For vr = lBound(vRespostas) to uBound(vRespostas)
							If Trim(Resposta)  = Trim(VRespostas(vr)) Then
								VR_Resposta = 1
								Exit For
							End If
						Next
						...
						vRespostas = ""
						'==================================================
						' FIM - Correcao do retorno das respostas repetidas
						'==================================================
...
'	MODELO NOVO 20130408 WAGNER
				...
				End If
					...
					oFiletxt.WriteLine("<convite>"				& limpar_formatacao(trocar(Ucase( convite ))) & "</convite>")
	...
	%>
        ...
        <big style="background-color:#FF0;"><a href="arquivos_<%=sAnoPasta%>/<%=Filename%>" target="_blank">Clique aqui * para salvar o arquivo.</a></big>&nbsp;* Botão direito > Salvar Como	<br>
