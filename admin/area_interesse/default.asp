...
If busca <> "" Then
	...
	condicoes = condicoes & " Where 	AreaInteresse_PTB like '%" & busca & "%' "
	condicoes = condicoes & " 		OR 	AreaInteresse_ENG like '%" & busca & "%' "
	condicoes = condicoes & " 		OR 	AreaInteresse_ESP like '%" & busca & "%' "
End If
...
Conexao.Open Application("cnn")
	...
	SQL_Listar = 	"Select " &_
					...
					"	" & condicoes & " " &_
					"Order by ID_AreaInteresse DESC"
  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;" align="center"><span style="color: #B01D22">Área de Interesse</span></td>
        <td width="270" align="center" valign="middle" style="font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold;">
	        <a href="/admin/rel_edicoes_interesse/"><img src="/admin/images/bt_link.png" height="48" border="0" style="float: left; margin-top: -5px;"/>
            <div id="relacionamento_link">Relacionar Áreas de Interesse</div></a>
        </td>
      ...
      <table width="600" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <input type="hidden" id="acao" name="acao" value="add_interesse">
              <tr>
              ...
              <tr>
                <td height="30" class="titulo_menu_site_bts">Área de Interesse - PTB</td>
                <td class="titulo_noticias_home"><input name="AreaInteresse_ptb" id="AreaInteresse_ptb" type="text" class="admin_txtfield_login" size="30" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Área de Interesse - ENG</td>
                <td class="titulo_noticias_home"><input name="AreaInteresse_eng" id="AreaInteresse_eng" type="text" class="admin_txtfield_login" size="30" /></td>
              </tr>
              <tr>
                <td height="30" class="titulo_menu_site_bts">Área de Interesse - ESP</td>
                <td class="titulo_noticias_home"><input name="AreaInteresse_esp" id="AreaInteresse_esp" type="text" class="admin_txtfield_login" size="30" /></td>
              </tr>
              <tr>
		...
		%>
            ...
            %>
              <tr bgcolor="#FFFFFF" 
                ...
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_AreaInteresse")%>';" align="left"><%=RS_Listar("ID_AreaInteresse")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_AreaInteresse")%>';" align="left"><%=Rs_listar("AreaInteresse_PTB")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_AreaInteresse")%>';" align="left"><%=Rs_listar("AreaInteresse_ENG")%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_AreaInteresse")%>';" align="left"><%=Rs_listar("AreaInteresse_ESP")%></td>
                <td class="borda_dir linha_16px cursor" align="center">
                <%
					ativo = Rs_listar("Ativo")
					If ativo = true OR ativo = 1 Then
						%><img src="/img/geral/icones/ok.gif" width="20" height="20" alt="ativo" title="ativo" onClick="document.location = 'metodos.asp?id=<%=Rs_listar("ID_AreaInteresse")%>&acao=desativar';"><%
					Else
						%><img src="/img/geral/icones/nok.gif" width="20" height="20" alt="desativado" title="desativado" onClick="document.location = 'metodos.asp?id=<%=Rs_listar("ID_AreaInteresse")%>&acao=ativar';"><%
                	End If
				%>
                </td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_AreaInteresse")%>';" align="left"><%=FormatDateTIme(Rs_listar("Data_Cadastro"),2)%></td>
                <td class="borda_dir linha_16px cursor" onClick="document.location = 'editar.asp?id=<%=Rs_listar("ID_AreaInteresse")%>';" align="center"><img src="/admin/images/ico_pg_prox.gif" width="15" height="15" alt="Ver Expositor" title="Ver Expositor" border="0"></td>
              </tr>
              <%
                RS_Listar.MoveNext()
            Wend
