...
If Len(Trim(Departamento)) > 0 Then
	SQL_Depto 		= "SELECT " &_
						"	ID_Depto as Id, " &_
    ...
    <div id="contBody">
    	<!--<span class="titulo_confirmacao"><%=textos_array(0)(2)%></span>-->
			        ...
			        <td class="arial fs_12px" style="line-height:15px; color: #58595B;"><p>
				        <% 
							...
							Select Case (ID_Edicao)
								...
								Case "47" ' Fispal Tecnologia
									texto = textos_array(24)(2)
								Case "48" ' Fispal Service
									texto = textos_array(26)(2)
								Case "49" ' Fispal Cafe
									texto = textos_array(26)(2)
								Case "50" ' Fispal Sorvete
									texto = textos_array(26)(2)
								' FIM - Texto especifico para as feiras
								Case Else
			...
			<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td style="text-align: right; color: #58595B; font-size: 10px" class="arial fs_12px">
						PARCERIA: <a href="http://www.almax.com.br/" target="blank"><img src="/img/geral/parceria_almax.png" border="0"/></a>
					</td>
				</tr>
			</table>
			<%
