...
<% End IF
	...
	' Select de Ramos de Atividades 
	SQL_RamoAtividade = 	"SELECT " &_
							"	R.ID_Ramo as Id, " &_
							"	R.Ramo_" & SgIdioma & " as Nome " &_
							"FROM Relacionamento_Edicoes_Ramo as RER " &_
							"Inner Join RamodeAtividade  as R ON R.ID_Ramo = RER.ID_Ramo " &_
							"WHERE " &_
							"	R.Ativo = 1 " &_
							"	AND RER.ID_Edicao = " & ID_Edicao & " " &_
							"	AND R.Ramo_" & SgIdioma & " IS NOT NULL " &_
							"	AND R.ID_Ramo <> -1 " &_
							"ORDER BY Nome " 
  ...
  <tr>
    ...
    <input type="hidden" id="id_visitante" 	name="id_visitante" 	value="" >
            ...
            <fieldset>
                ...
                <label style="width:390px"><!--Ramo de atividade--><%=textos_array(3)(2)%>
                   <select name="frmRamo" id="frmRamo" style="width:390px" onchange="getAtividade(this.value);">
						...
						<%
                            ...
                            If not RS_RamoAtividade.BOF or not RS_RamoAtividade.EOF Then
                                While not RS_RamoAtividade.EOF
                                    %>
                                        <option value="<%=RS_RamoAtividade("Id")%>" sigla="<%=caixaAltaBaixa("caixa_altabaixa",RS_RamoAtividade("Nome"))%>"><%=caixaAltaBaixa("caixa_altabaixa",RS_RamoAtividade("Nome"))%></option>
                                    <%
                ...
                <label id="Atividade" style="width:390px"><!--Atividade Economica--><%=textos_array(47)(2)%>
                    <select name="frmAtividade" id="frmAtividade" style="width:390px">
						<option value="-" sigla="-" selected="selected"><!--Selecione-->-- <%=textos_array(36)(2)%> --</option>
					</select>
					<input type="text" name="frmAtividadeOutros" id="frmAtividadeOutros" style="width:230px;display:visible"/><span class="bt_fechar" id="FecharAtividadeOutros" style="display:none" onclick="TipoAtividadeOff()">x</span>
                </label>
                <label style="width:390px" id="RamoOutros"><!--Outro Ramo--><%=textos_array(4)(2)%><input type="text" name="frmOptRamoOutros" id="frmOptRamoOutros" style="width:380px" max="150" maxlength="150"/></label>
                <br/>
                <label style="width:190px"><!--Principal produto--><%=textos_array(5)(2)%><input type="text" name="frmPriProdut" id="frmPriProdut" style="width:180px" max="150" maxlength="150" onkeyup="troca()"/></label>
			</fieldset>
            <fieldset>
            ...
            <fieldset>
                ...
                <br/>
           	  	<label style="width:700px"><!--O que você procura na--><%=textos_array(16)(2)%> <strong><%=Evento%> </strong>?</label>
                	<div id="divInteresse">
                        <ul>
                            <%
                                ' Looping de Interesses da Feira
            ...
            <fieldset>
                ...
                <label style="width:390px"><!--Departamento--><%=textos_array(27)(2)%>
                    ...
                    <input type="text" name="frmDeptoOutros" id="frmDeptoOutros" style="width:230px;display:none"/><span class="bt_fechar" id="FecharDeptoOutros" style="display:none" onclick="TipoDeptoOff()">x</span>
                </label>
                <br/>
            ...
            <fieldset>
                ...
                <label style="width:790px; margin-top:10px;"><!--Feiras--><%=textos_array(52)(2)%></label><br/>
                    <div id="parcFeira" class="div_parceria" style="height:275px;">
                        ...
                        %>
                                    <li><input type="checkbox" name="frmInteresseFeira" id="frmInteresseFeira" value="<%=RS_Feiras("ID")%>"/><span class="cursor" onclick="checar(<%=z%>,'<%=RS_Feiras("Nome")%>', 'frmInteresseFeira');$('input[name=frmInteresseFeira]')[<%=z%>].click();">&nbsp;&nbsp;<%=RS_Feiras("Nome")%></span></li>
                        <%
                                    z = z + 1
                                    RS_Feiras.MoveNext()
                                Wend
            ...
            <!-- End Alert error -->
			<div id="acSubmit" style="padding-top:15px;"><img src="<%=textos_array(40)(3)%>" onclick="Enviar()"/></div>
        </form>
        <!-- Form End -->
	</div>
    <!-- End Form Container -->
