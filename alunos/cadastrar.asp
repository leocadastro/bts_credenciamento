...
<table width="870" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <input type="hidden" id="id_visitante"  name="id_visitante"     value="" >
            ...
            <fieldset>
                <label style="width:110px">Tipo de Credencial
                    <select name="frmTipo" id="frmTipo" style="width:110px">
                ...
                <label style="width:200px">Nome<input type="text" name="frmNome" id="frmNome" style="width:190px" max="100" maxlength="100"/></label>
                <label style="width:200px">E-mail<input type="text" name="frmEmail" id="frmEmail" style="width:190px" max="40" maxlength="40"/></label>
                <label style="width:200px">Curso<input type="text" name="frmCurso" id="frmCurso" style="width:190px" max="40" maxlength="40"/></label>
            ...
            <fieldset style="display:none" id="editar">
                ...
                <label style="width:110px">Tipo de Credencial
                    ...
                    <select name="frmTipo2" id="frmTipo2" style="width:110px">
                        <option value="-"><!--Selecione-->-- <%=textos_array(36)(2)%> --</option>
                            <%                           
                            If not RS_TipoCredencial.BOF or not RS_TipoCredencial.EOF Then
                                While not RS_TipoCredencial.EOF 
                ...
                <label style="width:200px">Nome<input type="text" name="frmEditarNome" id="frmEditarNome" style="width:190px" max="100" maxlength="100"/></label>
                <label style="width:200px">E-mail<input type="text" name="frmEditarEmail" id="frmEditarEmail" style="width:190px" max="40" maxlength="40"/></label>
                <label style="width:200px">Curso<input type="text" name="frmEditarCurso" id="frmEditarCurso" style="width:190px" max="40" maxlength="40"/></label>
