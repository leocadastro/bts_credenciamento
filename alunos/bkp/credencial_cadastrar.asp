		...
		'=======================================================================
			...
			If Cint( qtde_disponivel ) > Qtde_Preenchida Then
				SQL_Inserir = 	"Insert Into Universidade_Credenciais " &_
								"(ID_Universidade_TipoCredencial, nome, Curso, id_edicao, id_empresa) " &_
								"values " &_
								"(" & id_tipo & ",Upper(dbo.sp_rm_accent_pt_latin1('" & nome & "')),Upper(dbo.sp_rm_accent_pt_latin1('" & curso & "'))," & Session("cliente_edicao") & "," & Session("cliente_empresa") & ")"
