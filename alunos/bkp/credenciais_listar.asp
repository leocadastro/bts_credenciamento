...
<table width="770" border="0" cellpadding="0" cellspacing="2">
  ...
  <tr>
	<td width="50" align="center" class="arial fs_13px cor_cinza2 borda_tabela" ><b>Nº </b></td>
	...
	<td width="50" align="center" class="arial fs_13px cor_cinza2 borda_tabela" ><b>Editar</b></td>
	<td width="50" align="center" class="arial fs_13px cor_cinza2 borda_tabela" ><b>Remover</b></td>
  </tr>
  <%
  ...
  <tr>
	...
	<td align="center" class="arial fs_12px cor_cinza1 borda_tabela">
        <img class="cursor" onClick="top.atualizar_credencial(<%=ID%>,'<%=nome%>','<%=Curso%>','<%=ID_Tipo%>');"
        src="/img/geral/icones/ico_editar.gif" width="20" height="20">
	</td>
	<td align="center" class="arial fs_12px cor_cinza1 borda_tabela">
		<img class="cursor" onClick="top.remover_credencial(<%=ID%>,'<%=nome%>','<%=Curso%>');"
  ...
  %>
  <tr>
	<td colspan="5" height="30" align="center" bgcolor="#990000" class="arial fs_12px cor_branco b borda_tabela">Nenhuma Credencial Cadastrada</td>
  </tr>
  <%
	End If
  %>
