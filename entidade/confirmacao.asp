			    ...
			    <td width="730" valign="top">
			      ...
			      <tr>
			        ...
			        <table border="0" align="center" class="div_parceria confirmacao" style="padding: 5px;">
			          <tr >
			            <td width="24%">
			            	<!--C&oacute;digo de identifica&ccedil;&atilde;o:--><strong><%=textos_array(3)(2)%></strong></td>
			          ...
			          <!-- ====================================================== -->
                       <tr>
			            <td><strong><!--CNPJ--><%=textos_array(8)(2)%></strong></td>
			            <td><%=CNPJMask%></td>
			          </tr>
			          <!-- ====================================================== -->
			          <tr>
			            <td><strong><!--Razão Social--><%=textos_array(9)(2)%></strong></td>
			            <td><%=RazaoSocial%></td>
			          </tr>
			          <!-- ====================================================== -->
			        </table></td>
