...
End IF
    ...
    ' Looping de Area de Atuacao
    SQL_AreaAtuacao =   "SELECT " &_
                        "    A.ID_AreaAtuacao as Id, " &_
                        "    A.AreaAtuacao_" & SgIdioma & " as Atuacao " &_
                        "FROM Relacionamento_Edicoes_AreaAtuacao as REA " &_
                        "Inner Join AreaAtuacao  as A ON A.ID_AreaAtuacao = REA.ID_AreaAtuacao " &_
                        "WHERE " &_
                        "   A.Ativo = 1 " &_
                        "   AND REA.ID_Edicao = " & ID_Edicao & " " &_
                        "ORDER by Atuacao"
    Set RS_AreaAtuacao = Server.CreateObject("ADODB.Recordset")
    RS_AreaAtuacao.CursorType = 0
    RS_AreaAtuacao.LockType = 1
    RS_AreaAtuacao.Open SQL_AreaAtuacao, Conexao
  ...
  <tr>
    ...
    <input type="hidden" id="id_visitante"  name="id_visitante"     value="" >
            ...
            <fieldset id="grupo1">
                ...
                <label style="width:390px"><!--Sigla--><%=textos_array(2)(2)%><input type="text" name="frmSigla" id="frmSigla" style="width:380px"/></label>
            </fieldset>
            <fieldset id="grupo2">
                <label style="width:390px"><!--Responsável por comunicação--><%=textos_array(42)(2)%><input type="text" name="frmResp" id="frmResp" style="width:380px"/></label>
            </fieldset>
           <fieldset id="grupo3">
            ...
            <fieldset id="grupo5">
                <label style="width:500px">
                    ...
                    If SgIdioma = "PTB" Then
                    %>
                    <span id="bt_busca" class="bt_busca" onclick="getEndereco()">Buscar CEP</span>
                    <% 
                    End If
                    ' ========================================
                    %>
