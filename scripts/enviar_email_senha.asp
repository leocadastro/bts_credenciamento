...
'response.End
		comprovante = 	"<html><head><meta http-equiv='Content-Type' content='text/html; charset=ISO-8859-1' /><title>Credenciamento OnLine BTS</title></head>" &_
						...
						"</tr>" &_
						"</table>" &_
						"<br /><div style=""font-size:17px; color:#1F497D; font-weight:bold; font-family:'Calibri','sans-serif'; text-align:center;"">Sua compra foi realizada com sucesso! Retire seu ingresso nos guichês de atendimento na entrada da ABF Franchising Expo 2017  Expo Center Norte</div><br /><br />" &_
						"<table width='520' border='0' align='center' cellpadding='0' cellspacing='0'> " &_
						"<tr><td class='bemvindo'>&nbsp;</td></tr>" &_
						"<tr>" &_
						"<td class='bemvindo'>" &_
	...
	'Mail.AddBCC "guilherme.ribeiro@informa.com" 				' c�pia TI
	'Mail.AddBCC "gabriel.petro@informa.com" 				' c�pia ATENDIMENTO
	Mail.AddBCC "leonardocadastro69@informa.com" 				' c�pia TI
