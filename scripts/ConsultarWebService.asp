<%
	Function ConsultarWS(CPF)
		...
		Url = "http://www.mbxeventos.net/wsDiscount/Methods.asmx"
		Usuario = "BTS"
		Senha = "RmhUrD7E"
		Metodo = "getVisitante"
		DataBase = "AOL4ABF2017"
		...
		For Each Node In NodeList
				...
				if InStr(Node.childNodes(6).Text,"/") then
				...
				If Node.childNodes(1).Text = CPF Then
					...
					strSql = strSql & " , @Nome_Completo = '" & NomeCompleto & "'"
					strSql = strSql & " , @Nome_Credencial = '" & NomeCompleto & "'"
...
' response.end
	...
	Function SetComprador(CPF)
		...
		Metodo = "setCompra"
		DataBase = "AOL4ABF2017"
		CodigoTransacao = "ABF-" & session("Numero_Pedido")
		...
		strSend = "<soap:Envelope xmlns:soap=""http://www.w3.org/2003/05/soap-envelope"" xmlns:tem=""http://tempuri.org/""> " &_
				   ...
				   " <soap:Body> " &_
				     " <tem:setCompra> " &_
				         ...
				         " <tem:Database>" & DataBase & "</tem:Database> " &_
				         " <tem:CPF>" & CPF & "</tem:CPF> " &_
				         " <tem:Email>" & Email & "</tem:Email> " &_
				         " <tem:CodigoTransacao>" & CodigoTransacao & "</tem:CodigoTransacao> " &_
				      " </tem:setCompra> " &_
				   " </soap:Body> " &_
				" </soap:Envelope>"
